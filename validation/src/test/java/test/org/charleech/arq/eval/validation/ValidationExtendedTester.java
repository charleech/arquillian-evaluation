...
public class ValidationExtendedTester extends AbstractValidationTester {
     ...
     * @since 0.0.1
     */
    @Deployment(name="extended")
    public static EnterpriseArchive deploy() {
        return ArchivePreparation.getINSTANCE().getDeployingExtended();
    }
}

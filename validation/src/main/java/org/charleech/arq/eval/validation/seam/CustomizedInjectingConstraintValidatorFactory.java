...
*/
@Slf4j
public class CustomizedInjectingConstraintValidatorFactory
  ...
  implements ConstraintValidatorFactory {
   ...
   private final ConstraintValidatorFactory delegate;
     ...
     */
   public CustomizedInjectingConstraintValidatorFactory() {
       CustomizedInjectingConstraintValidatorFactory.log.info(
   ...
   public <T extends ConstraintValidator<?, ?>>
       ...
       try {
           ...
           CustomizedInjectingConstraintValidatorFactory.log.trace(
              "The bean manager is {}",
              beanManager);
           ...
           if (!beans.isEmpty()) {
               ...
               CustomizedInjectingConstraintValidatorFactory.log.debug(
                  "The value is {}",
                  theValue);
           } else {
               CustomizedInjectingConstraintValidatorFactory.log.info(
